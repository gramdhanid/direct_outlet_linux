...
#define GPIO_INPUT_BUTTON 26

#define GPIO_OUTPUT_MAINLED 33
#define GPIO_OUTPUT_MAINLED_0 0 /* use as ground */

#define GPIO_OUTPUT_RELAY 4

#define GPIO_OUTPUT_NOUSE1 0
#define GPIO_OUTPUT_NOUSE2 0

#define LED_DARK_LOW 0
#define LED_DARK_HIGH 1
